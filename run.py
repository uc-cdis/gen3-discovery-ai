...
from gen3openai.main import get_app


CURRENT_DIR = os.path.dirname(os.path.realpath(__file__))

cdislogging.get_logger(None, log_level="debug" if gen3openai.config.DEBUG else "warn")
...
if __name__ == "__main__":
    if sys.argv[-1] == "openapi":
        ...
        uvicorn.run("gen3openai.main:app", reload=True, log_config=None)
